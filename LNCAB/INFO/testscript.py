...
g2.save()
up1 = User.objects.create_user(username='p1', email='p1@mail', password='pass', first_name="p1first", last_name="p1last")
up2 = User.objects.create_user(username='p2', email='p2@mail', password='pass', first_name="p2first", last_name="p2last")
uc1 = User.objects.create_user(username='c1', email='c1@mail', password='pass', first_name="c1first", last_name="c1last")
uc2 = User.objects.create_user(username='c2', email='c2@mail', password='pass', first_name="c2first", last_name="c2last")
