...
from tournaments.views import GamesView, DetailView, BracketView, TeamDetailView, StatisticsView, TournamentsView, TournamentDetailView,TeamsView,myGamesView
