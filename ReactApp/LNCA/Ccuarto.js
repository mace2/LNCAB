...
const { width: WIDTH } = Dimensions.get('window');
 ...
 class Ccuarto extends React.Component {
   constructor(props){
       super(props);
       ...
       return fetch('https://mace2.github.io/json.json')
         ...
         .then((responseJson) => {
           ...
           this.setState({
             ...
             local_q: responseJson[0].local_q4 + "",
             visitor_q: responseJson[0].visitor_q4 + ""
           }, function(){
  ...
  render(){
    ...
    return (
      ...
      <TouchableOpacity style={styles.btnLogin} onPress={() => navigate('Second', {name: 'Manuel'})}>
